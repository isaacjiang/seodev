...
!function (e, t, n) {
    ...
    !function () {
        ...
        function e(e, n, o, r, i, a) {
            this.compile = function (d) {
                ...
                return t.forEach(u, function (e, n) {
                    ...
                    var n, o = p(e.$template, d), a = d.element || t.element("<div>").html(o.trim()).contents(), c = r(a);
                    return n = {
        ...
        function o(n, o, r) {
            ...
            function c(e, o) {
                var r = new n(e);
                return t.extend(r, o), p[e] = r, g
            }

            var s = navigator.userAgent || navigator.vendor || e.opera, m = s.match(/ipad|iphone|ipod/i), u = s.match(/android/i), h = "undefined" != typeof e.jQuery && t.element === e.jQuery, g = {
                handler: c,
                register: a,
                isHijackingClicks: (m || u) && !h && !f
            };
        ...
        function a(e, n) {
            ...
            function a(e) {
                if (!u) {
                    var t = +Date.now();
                    h && !c(e, h) && t - h.endTime < 1500 || (u = d(e), i("start", e))
                }
            }
            ...
            function f(e) {
                u && c(e, u) && (l(e, u), u.endTime = +Date.now(), i("end", e), h = u, u = null)
            }
        ...
        !function () {
            ...
            function r(e, n) {
                ...
                return function (r) {
                    var i = a(n, r || "");
                    t.isDefined(i) && (o && e.removeClass(o), o = i ? n + "-" + i.replace(p, "-") : n, e.addClass(o))
                }
            }
        ...
        function o(e) {
            function n(n, o, i) {
                return o.controller("mdNoInk") ? t.noop : e.instantiate(r, {$scope: n, $element: o, rippleOptions: i})
            }
        ...
        function i(e, n, o) {
            ...
            return o = o.replace(m, function (t, n, o, r, i) {
                ...
                if ("default" !== n && (i = i.replace(a, ".md-" + e.name + "-theme.md-" + n)), "default" == e.name) {
                    var d = /((?:(?:(?: |>|\.|\w|-|:|\(|\)|\[|\]|"|'|=)+) )?)((?:(?:\w|\.|-)+)?)\.md-default-theme((?: |>|\.|\w|-|:|\(|\)|\[|\]|"|'|=)*)/g;
                    i = i.replace(d, function (e, t, n, o) {
                        return e + ", " + t + n + o
                    })
                }
                r.push(i)
        ...
        function e(e, n, o, r, i) {
            ...
            return a = {
                translate3d: function (e, t, n, o) {
                    ...
                    var r = o.element, i = o.bounds, d = "translate3d( {centerX}px, {centerY}px, 0 ) scale( {scaleX}, {scaleY} )", c = t.bind(null, e.supplant, d), s = c({
                        centerX: 0,
                        centerY: 0,
                        scaleX: .5,
                        scaleY: .5
                    ...
                    if (r || i) {
                        var l = r ? a.clientRect(r) : a.copyRect(i), m = a.copyRect(n[0].getBoundingClientRect()), u = a.centerPointFor(m), h = a.centerPointFor(l);
                        s = c({
                            centerX: h.x - u.x,
                            centerY: h.y - u.y,
                            scaleX: Math.round(100 * Math.min(.5, l.width / m.width)) / 100,
                            scaleY: Math.round(100 * Math.min(.5, l.height / m.height)) / 100
                        })
                    }
                    return s
                }, toCss: function (e) {
        ...
        function o(e) {
            ...
            function r(e, o, r, i, a, d, c, s) {
                function l(e, n, o, i) {
                    ...
                    function c() {
                        if (i) {
                            var e = /<\/[\w-]*>/gm, t = i.content || o.content || "", n = e.test(t);
                            n || (t = r.supplant("<p>{0}</p>", [t])), i.mdContent = t
                        }
                    }

                    return t.element(d[0].body).addClass("md-dialog-is-showing"), c(), u(o), f(n.find("md-dialog"), o), p(e, n, o), E(n, o).then(function () {
                        h(n, o), g(n, o), a()
                    })
                }
                ...
                function m(e, n, o) {
                    ...
                    function i() {
                        t.element(d[0].body).removeClass("md-dialog-is-showing"), n.remove(), o.$destroy || o.origin.focus()
                    }
                ...
                function u(e) {
                    ...
                    function r(e, n) {
                        if (t.isString(e)) {
                            var o = e, r = d[0].querySelectorAll(o);
                            e = r.length ? r[0] : null
                        }
                    ...
                    e.origin = t.extend({
                        ...
                        bounds: null,
                        focus: t.noop
                    }, e.origin || {}), e.parent = r(e.parent, s), e.closeTo = o(r(e.closeTo)), e.openFrom = o(r(e.openFrom)), e.targetEvent && (e.origin = o(e.targetEvent.target, e.origin))
                }

                function h(n, o) {
                    var a = t.element(c), d = r.debounce(function () {
                        b(n, o)
                    }, 60), s = [], l = function () {
                    ...
                    if (o.escapeToClose) {
                        var m = o.parent, u = function (e) {
                            e.keyCode === i.KEY_CODE.ESCAPE && (e.stopPropagation(), e.preventDefault(), l())
                        };
                        n.on("keydown", u), m.on("keydown", u), a.on("resize", d), s.push(function () {
                            n.off("keydown", u), m.off("keydown", u), a.off("resize", d)
                        })
                    }
                ...
                function p(e, t, n) {
                    n.disableParentScroll && (n.restoreScroll = r.disableScrollAround(t, n.parent)), n.hasBackdrop && (n.backdrop = r.createBackdrop(e, "md-dialog-backdrop md-opaque"), a.enter(n.backdrop, n.parent)), n.hideBackdrop = function (e) {
                        n.backdrop && (e ? n.backdrop.remove() : a.leave(n.backdrop)), n.disableParentScroll && (n.restoreScroll(), delete n.restoreScroll), n.hideBackdrop = null
                    }
                }

                function f(e, t) {
                    var n = "alert" === t.$type ? "alertdialog" : "dialog", i = e.find("md-dialog-content"), a = e.attr("id") || "dialog_" + r.nextUid();
                    e.attr({
                        role: n,
                        tabIndex: "-1"
                    }), 0 === i.length && (i = e), i.attr("id", a), e.attr("aria-describedby", a), t.ariaLabel ? o.expect(e, "aria-label", t.ariaLabel) : o.expectAsync(e, "aria-label", function () {
                ...
                function g(e, t) {
                    function n(e) {
                        for (; e.parentNode;) {
                            ...
                            for (var t = e.parentNode.children, r = 0; r < t.length; r++)e === t[r] || M(t[r], ["SCRIPT", "STYLE"]) || t[r].setAttribute("aria-hidden", o);
                            n(e = e.parentNode)
                        }
                    }
                ...
                function b(e, t) {
                    var n = "fixed" == c.getComputedStyle(d[0].body).position, o = t.backdrop ? c.getComputedStyle(t.backdrop[0]) : null, i = o ? Math.min(d[0].body.clientHeight, Math.ceil(Math.abs(parseInt(o.height, 10)))) : 0;
                    return e.css({top: (n ? r.scrollTop(t.parent) : 0) + "px", height: i ? i + "px" : "100%"}), e
                }

                function E(e, t) {
                    t.parent.append(e), b(e, t);
                    ...
                    return o.translate3d(n, d, c, a).then(function (e) {
            ...
            return o.$inject = ["$mdDialog", "$mdTheming"], r.$inject = ["$mdDialog", "$mdAria", "$mdUtil", "$mdConstant", "$animate", "$document", "$window", "$rootElement"], e("$mdDialog").setDefaults({
        ...
        !function () {
            function e(e, n, o, r, i, a) {
                function d() {
                    _.direction = _.direction || "down", _.isOpen = _.isOpen || !1, m()
                }

                function c() {
                    var o = ["$md.pressdown", "click", "focusin", "focusout"];
                ...
                function s(e) {
                    H && (l(H) || H.$material) || (l(e) ? (w(e), H = e) : "focusin" == e.type ? _.open() : "focusout" == e.type && _.close(), a(function () {
                        H = null
                    }, 100, !1))
                }

                function l(e) {
                    return "$md.pressdown" == e.type || "click" == e.type
                }
                ...
                function u() {
                    e.$watch("vm.direction", function (e, t) {
                        o.removeClass(n, "md-" + t), o.addClass(n, "md-" + e), m()
                    });
                    var t, r;
                ...
                function h() {
                    r.nextTick(function () {
                        o.addClass(n, "md-noop")
                    })
                }

                function p() {
                    t.element(document).on("keydown", g)
                }

                function f() {
                    t.element(document).off("keydown", g)
                }
                ...
                function w(e) {
                    T(e.target) && _.toggle(), k(e.target) && _.close()
                }
            ...
            function r() {
                function n(n) {
                    ...
                    t.forEach(a, function (e, t) {
                        var n = e.style, r = t * o;
                        n.opacity = i.isOpen ? 1 : 0, n.transform = n.webkitTransform = i.isOpen ? "scale(1)" : "scale(0.1)", n.transitionDelay = (i.isOpen ? r : a.length - r) + "ms", n.zIndex = a.length - t + c
                    })
                }
                ...
                restrict: "E", controller: "MdListController", compile: function (a, d) {
                    ...
                    function s(n) {
                        ...
                        if ("div" == n)o = t.element('<div class="md-no-style md-list-item-inner">'), o.append(a.contents()), a.addClass("md-proxy-focus"); else {
                            ...
                            var r = ["ng-click", "aria-label", "ng-disabled", "ui-sref", "href", "ng-href", "ng-attr-ui-sref"];
                    ...
                    function m(e, a, d, c) {
                        ...
                        function l() {
                            ...
                            e.length && !e[0].hasAttribute("ng-click") && t.forEach(i, function (e) {
                                t.forEach(h.querySelectorAll(e), function (e) {
                                    u.push(e)
                                })
                            })
                        }
                        ...
                        function m() {
                            (u.length || p) && (a.addClass("md-clickable"), c.attachRipple(e, t.element(a[0].querySelector(".md-no-style"))))
                        }

                        var u = [], h = a[0].firstElementChild, p = h && s(h);
                        ...
                        }), p || u.length || h && h.addEventListener("keypress", function (e) {
                            if ("INPUT" != e.target.nodeName && "TEXTAREA" != e.target.nodeName) {
                                var t = e.which || e.keyCode;
                                t == n.KEY_CODE.SPACE && h && (h.click(), e.preventDefault(), e.stopPropagation())
                            }
                        }), a.off("click"), a.off("keypress"), u.length && h && a.children().eq(0).on("click", function (e) {
                            var n = o.getClosest(e.target, "BUTTON");
                            !n && h.contains(e.target) && t.forEach(u, function (n) {
                    ...
                    if (a[0].setAttribute("role", "listitem"), d.ngClick || d.ngHref || d.href || d.uiSref || d.ngAttrUiSref)s("button"); else {
                        ...
                        u ? s("div") : a[0].querySelector("md-button:not(.md-secondary):not(.md-exclude)") || a.addClass("md-no-proxy")
                    }
                    return c(), m
                }
            }
        ...
        function o(e, o, r) {
            ...
            function a(r, i, a) {
                ...
                l.setMultiple = function (e) {
                    ...
                    var o = l.ngModel;
                    u = u || o.$isEmpty, l.isMultiple = e, m && m(), l.isMultiple ? (o.$validators["md-multiple"] = n, o.$render = d, r.$watchCollection(i.ngModel, function (e) {
                ...
                l.optNodeForKeyboardSearch = function (e) {
                    ...
                    p || (p = a.find("md-option"), f = new Array(p.length), t.forEach(p, function (e, t) {
                        f[t] = e.textContent.trim()
                    }));
                    for (var r = 0; r < f.length; ++r)if (o.test(f[r]))return p[r]
                }, l.init = function (n) {
            ...
            return a.$inject = ["$scope", "$attrs", "$element"], {
                restrict: "E", require: ["mdSelectMenu", "?ngModel"],
                controller: a, link: {pre: i}
            }
        }
        ...
        function e(e, n, o, r, i, a, d, c, s) {
            function l(l, h, p) {
                ...
                function E() {
                    x.attr("aria-label") || x.text().trim() || x.attr("aria-label", h.text().trim())
                }
                ...
                function M() {
                    for (var e = h.parent(); y("pointer-events", "none", e);)e = e.parent();
                    return e
                }

                function $() {
                    for (var e = h.parent()[0]; e && e !== d[0] && e !== document.body && "MD-CONTENT" !== e.nodeName;)e = e.parentNode;
                    return e
                }
                ...
                function A() {
                    var e = !1, o = t.element(n), i = function () {
                        a = document.activeElement === x[0]
                    }, a = !1;
                    o.on("blur", i), l.$on("$destroy", function () {
                        o.off("blur", i)
                    });
                    var d = function (e) {
                        return "focus" === e.type && a ? void(a = !1) : (x.on("blur mouseleave touchend touchcancel", c), void C(!0))
                    }, c = function () {
                        var t = l.hasOwnProperty("autohide") ? l.autohide : p.hasOwnProperty("mdAutohide");
                        (t || e || r[0].activeElement !== x[0]) && (x.off("blur mouseleave touchend touchcancel", c), x.triggerHandler("blur"), C(!1)), e = !1
                    };
                    x.on("mousedown", function () {
                        e = !0
                    }), x.on("focus mouseenter touchstart", d), t.element(n).on("resize", D)
                }

                function C(t) {
                    C.value = !!t, C.queued || (t ? (C.queued = !0, e(function () {
                        l.visible = C.value, C.queued = !1
                ...
                function T() {
                    return S.append(h), y("display", "none") ? (l.visible = !1, void h.detach()) : (w(), void t.forEach([h, N], function (e) {
                ...
                function w() {
                    function e(e) {
                        ...
                        return t.left = Math.min(t.left, S.prop("scrollWidth") - n.width - u), t.left = Math.max(t.left, u), t.top = Math.min(t.top, S.prop("scrollHeight") - n.height - u), t.top = Math.max(t.top, u), t
                    }
                    ...
                    var n = i.offsetRect(h, S), o = i.offsetRect(x, S), r = t(_);
                    _ ? r = e(r) : r.top > h.prop("offsetParent").scrollHeight - n.height - u && (r = e(t("top"))), h.css({
                        top: r.top + "px",
                        left: r.left + "px"
                    })
                }
                ...
                a(h);
                var x = M(), N = t.element(h[0].getElementsByClassName("md-content")[0]), _ = p.mdDirection, H = $(), S = t.element(H || document.body), D = o.throttle(function () {
                    l.visible && w()
                });
                f(), v(), A(), b(), E(), N.css("transform-origin", g(_))
            }
        ...
        function e(e, o, a, d, c, s, l, m, u, h) {
            ...
            function f() {
                ...
                function n() {
                    ...
                    e.right > s.right - i && (t.left = d.right - e.width + "px"), le.$.scrollContainer.css(t)
                }

                if (!le)return a.nextTick(f, !1, e);
                var d = le.wrap.getBoundingClientRect(), c = le.snap.getBoundingClientRect(), s = le.root.getBoundingClientRect(), l = c.bottom - s.top, m = s.bottom - c.top, u = d.left - s.left, h = d.width, p = t(), g = {
                    left: u + "px",
                    minWidth: h + "px",
                    maxWidth: Math.max(d.right - s.left, s.right - d.left) - i + "px"
                };
                l > m && s.height - d.bottom - i < r ? (g.top = "auto", g.bottom = m + "px", g.maxHeight = Math.min(r, d.top - s.top - i) + "px") : (g.top = l - p + "px", g.bottom = "auto", g.maxHeight = Math.min(r, s.bottom - d.bottom - i) + "px"), le.$.scrollContainer.css(g), a.nextTick(n, !1)
            }
            ...
            function D(t, n) {
                de.index = U(), t !== n && F(e.selectedItem).then(function (o) {
                    t !== o && (e.selectedItem = null, t !== n && N(), G() ? ie() : (de.matches = [], z(!1), ee()))
                })
            }
            ...
            function L(e) {
                switch (e.keyCode) {
                    ...
                    case d.KEY_CODE.ENTER:
                        if (e.stopPropagation(), e.preventDefault(), de.hidden || de.loading || de.index < 0 || de.matches.length < 1)return;
                        Q(de.index);
                        break;
            ...
            function Q(t) {
                a.nextTick(function () {
                    F(de.matches[t]).then(function (e) {
                        ...
                        e.selectedItem = de.matches[t], z(!1)
                    })
                }, !1)
            }

            function Z() {
                z(!0), de.index = 0, de.matches = [], e.searchText = "", Q(-1);
            ...
            function J(n) {
                ...
                t.isArray(r) ? o(r) : r && (z(!0), a.nextTick(function () {
        ...
        function e(e, o, r, i, a, d, c, s, l, m) {
            ...
            g("stretchTabs", v), W("focusIndex", T, ce.selectedIndex || 0), W("offsetLeft", C, 0), W("hasContent", A, !1), W("maxTabWidth", $, G()), W("shouldPaginate", y, !1),
